...
<div class="seoul-common-wrap">
	<div class="seoul-common-inner">
		<h1><a href="home"><img alt="서울특별시" src="resources/seoul.png"></a></h1>
		<div class="gnb-wrap">
			<nav id="gnb">
				<ul>
...
<c:if test="${!(empty cate)}">
<c:set var="categories" value="${cate }"/>
</c:if>		

<h1>로그인 페이지</h1>

<h3>
	카테고리 아이디 : ${categories.categoryID}<br/>
	카테고리 이름 : ${categories.categoryName}<br/>
	카테고리 설명 : ${categories.description}<br/>
</h3>